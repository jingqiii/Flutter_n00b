...
lib.ssMetadata = [
		{name:"300x250_atlas_P_", frames: [[152,608,150,150],[152,304,150,150],[304,304,150,150],[0,456,150,150],[152,456,150,150],[304,456,150,150],[0,608,150,150],[0,760,150,150],[0,304,150,150],[304,608,150,150],[0,0,150,150],[152,0,150,150],[304,0,150,150],[0,152,150,150],[152,152,150,150],[304,152,150,150],[152,760,200,29]]}
];
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function loadData() {
			...
			amo.registerVariation("animationType", "DataBrick");//Cube, Bar, Wave, Triangle, Arrows, Code, Chat, Square, DataBrick, Serverless
	...
	this.StaticDataBrick.name = "StaticDataBrick";
	this.StaticDataBrick.parent = this;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x250_atlas_P_.png?1563441878223", id:"300x250_atlas_P_"}
	],
	preloads: []
};
